...
class PlayblastWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.create_widgets()
        self.create_layouts()
        # 20251217 yang yongtao vp2 set
        '''
        sys.path.append(os.path.dirname(__file__))
        import vp2Optimizer as vp2
        import imp
        [imp.reload(mod) for mod in [vp2]]
        result = vp2.optimize_viewport()
        print('>>>ViewPoint2 Optimize:',result)
        '''
...
class PlayBlastWidget(QtWidgets.QWidget):
    ...
    def create_connections(self):
        ...
        self.toggle_mask_btn.clicked.connect(self.mask_toggle_clicked)#(self.shot_mask_wdg.toggle_mask)
    ...
    def mask_toggle_clicked(self):
        self.shot_mask_wdg.toggle_mask()
        # 20251217 yang yongtao vp2 set
        sys.path.append(os.path.dirname(__file__))
        try:
            import vp2Optimizer as vp2
