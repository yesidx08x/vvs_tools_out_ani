...
from stage.UI.widgets.common import MessageBox, ButtonBox
...
class SMessageBox:
    ...
    def pop_info(
        ...
        msg = MessageBox(parent=self.parent)
    ...
    def pop_question(
        ...
        q = MessageBox(parent=self.parent)
...
class Confirmation(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None, confirmation_word=None):
        ...
        button_box = ButtonBox(QtWidgets.QDialogButtonBox.Ok | QtWidgets.QDialogButtonBox.Cancel)
