...
class Project(ProjectCore):
    ...
    asset_work_path = 'R:/{id}_LBB/VFX/Assets/CGassets/{type}/{task}/{category}/Work/{project}_{task}_{abridge}_{alias}_{version}'
    asset_publish_path = 'R:/{id}_LBB/VFX/Assets/CGassets/{type}/{task}/{category}/Publish/{version}/{project}_{task}_{abridge}_{alias}'

    shot_work_path = 'R:/{id}_LBB/VFX/Sequences/{seq}/{shot}/{category_folder}/{category}/Work/{project}_{seq}_{shot}_{abridge}_{alias}_{version}'
    shot_publish_path = 'R:/{id}_LBB/VFX/Sequences/{seq}/{shot}/{category_folder}/{category}/Publish/{version}/{project}_{seq}_{shot}_{abridge}_{alias}'

    asset_review_path = 'R:/{id}_LBB/Assets/CGassets/{type}/{task}/Review/{category}/Publish/Internal/{project}_{task}_{abridge}_{alias}_{version}'
    shot_review_path = r'R:/{id}_LBB/VFX/Sequences/{seq}/{shot}/Review/{category}/Publish/Internal/{project}_{seq}_{shot}_{abridge}_{alias}_{version}'

    dailies_asset_path = 'R:/{id}_LBB/ProductionFolder/VFX_Dailies/Date/' + datetime.now().strftime(
        "%Y%m%d") + '/{category}/{project}_{task}_{abridge}_{alias}_{version}'
    dailies_shot_path = 'R:/{id}_LBB/ProductionFolder/VFX_Dailies/Date/' + datetime.now().strftime(
