...
set prefs_workspaces=%userprofile%/documents/maya/2025/prefs/workspaces
::if exist %prefs_workspaces%/Animation.json (
robocopy /e /mir /mt:4 L:\VVS_PIPELINE\pipeline\in_house\maya\2025\prefs\workspaces %prefs_workspaces%
::)
